# Extract vocabulary from a German text

You are given the main text content of a webpage in German. Extract useful vocabulary for a learner at CEFR level **{level}**.

## Rules

- Skip too basic words (ist, und, der, die, das — unless level is A1).
...
- Provide lemma form (infinitive for verbs, nominative singular without article for nouns).
